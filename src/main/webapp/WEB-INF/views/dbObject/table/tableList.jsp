...
<html>
  <head>
    <meta charset="UTF-8" />
    <title>테이블 관리</title>
    <link href="${pageContext.request.contextPath}/resources/css/dbObject/table/tableList.css" rel="stylesheet" />
            ...
            <div class="table-search">
              ...
              <div class="container-fluid">
                <form class="d-flex search-form">
                  <input class="form-control" type="search" id="tableNameSearch" placeholder="Search" aria-label="Search" />
                ...
                <div class="tables-management">
                  ...
                  <sec:authorize access="hasRole('ROLE_USER') and !hasRole('ROLE_DBA')">
                    <div class="tables-buttons">
                      <a href="tableAddForm"><button class="btn-add btn-accent">추가</button></a>
                      <button class="btn-edit btn-normal">수정</button>
                    </div>
                  </sec:authorize>
                  <sec:authorize access="hasRole('ROLE_DBA')">
                    <button class="btn-dataType btn-normal" data-bs-toggle="modal" data-bs-target="#dataTypeModal">데이터타입 관리</button>
                  </sec:authorize>
                </div>
            ...
            <div class="container team-container">
              <div class="row d-flex gap-4">
                <div class="col team-container">
                  ...
                  <table class="table table-container" id="dataTypeTable">
                    <thead class="table-light">
                      <tr>
                        <th scope="col">No.</th>
                ...
                <div class="col team-form">
                  ...
                  <table class="table table-container" id="dataTypeTable">
                    <tr>
                      ...
                      <td>
                        <input type="text" id="dataType" class="form-control" placeholder="입력" required />
                      </td>
                    </tr>
                    <tr>
                  ...
                  <div class="button-group d-flex justify-content-end gap-2">
                    <button class="btn-typeAdd btn-accent" type="button">추가</button>
                    <button class="btn-typeEdit btn-normal" type="button" disabled>수정</button>
                  </div>
                </div>
              </div>
            </div>
