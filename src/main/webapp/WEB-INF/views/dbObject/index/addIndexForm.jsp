Here’s your JSP code with comments removed and spacing adjusted:
...
<html>
  <head>
    <meta charset="UTF-8" />
    <title>인덱스 신청</title>
    <link rel="stylesheet" href="${pageContext.request.contextPath}/resources/css/dbObject/index/addIndexForm.css" />
  </head>
  <body>
    <div class="container">
      <div class="row">
            ...
            <div class="container index-tables">
              <div class="row">
                ...
                <div class="col index-col-table">
                  <div class="index-col-title d-flex justify-content-between align-items-end">
                    <div>
                      <span>UNIQUE</span>
