	...
	<div class="d-flex flex-column justify-content-center align-items-center join-container">
		...
		<div class="col-12 d-flex flex-column align-items-center">
			...
			<div class="input-group">
				...
				<input type="password" class="form-control" placeholder="비밀번호 재입력" id="mPasswordConfirm" aria-label="mPasswordConfirm" aria-describedby="mPasswordConfirm">
			</div>
			<div class="input-group">
			...
			<div class="input-group">
				...
				<select class="form-select" id="mTeam" aria-label="mTeam" aria-describedby="mTeam">
			...
			<div class="input-group">
				...
				<input type="text" class="form-control" placeholder="예) 010-1234-5678" id="mPhone" aria-label="mPhone" aria-describedby="mPhone">
			</div>
			<div class="input-group">
				<label for="mRole" class="input-label">계정 권한</label>
				<div class="form-check form-check-inline">
					<input class="form-check-input" type="radio" name="accountRole" id="roleUser" value="User" checked>
					<label class="form-check-label" for="roleUser">User</label>
				</div>
				<div class="form-check form-check-inline">
					<input class="form-check-input" type="radio" name="accountRole" id="roleDBA" value="DBA">
